...
class ApplyV2 extends React.Component {
    constructor(props) {
    ...
    render() {
        ...
        try {
            ...
            if (window && window.innerHeight && window.innerHeight > 480) {
                document.querySelector("._loading_overlay_wrapper").style.overflow = "hidden";
            }
        ...
        return (
            <div className={styles["main-wrapper-container"]}>
                <div className={styles["main-wrapper"]}>
                    ...
                    >
                        ...
                        <div className={styles["main-job-content-container"]}>
                            ...
                            <div className={styles.secRawContainer}>
                ...
                <div className={styles.stickyWrapper}>
                    ...
                    <span className={styles["close-btn"]} onClick={this.props.close_btn.bind(this)}>
