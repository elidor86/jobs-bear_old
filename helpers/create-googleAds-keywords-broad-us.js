...
let fileName = './helpers/lists/broad-us.txt';
let fileNameOutput = 'broad-us.csv';
...
const main = function () {
    ...
    lineReader.on('line', function (line) {
        ...
        if (line.search("'") > -1 || line.search(/(prescription|dermatology|med aid|medication|ppe|mask fitting)/igm) > -1) {
